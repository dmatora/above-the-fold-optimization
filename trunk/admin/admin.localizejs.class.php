				...
				<div id="post-body-content">
					<div class="postbox">
						...
						<div class="inside">
							...
							<p><strong>Status: <?php if (intval($options['localizejs_enabled']) === 1) { print '<font color="green">enabled</font>'; } else { print '<font color="red">disabled</font>'; } ?></strong> (enable/disable via <a href="tools.php?page=abovethefold&tab=settings#localizejs">settings</a>)</p>
